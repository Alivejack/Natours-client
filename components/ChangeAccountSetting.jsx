    ...
    <>
      ...
      >
        ...
        <input
          ...
          className={`w-[80%] px-3 py-2 mb-4 border rounded-lg focus:outline-none focus:ring-2 mt-2 bg-gray-200
            ${
              email
                ? emailIsValid
      ...
      <span className="w-full block border-b border-gray-300 mt-10"></span>
    </>
  );
}
